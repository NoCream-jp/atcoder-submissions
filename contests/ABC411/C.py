        ...
        if 1 < N:
            if l[idx] == 0:  # 白 -> 黒
                if idx != 0 and idx != N - 1:
                    if l[idx - 1] == 0 and l[idx + 1] == 0:  # 新たに黒を作った場合
                        ans += 1
                    elif l[idx - 1] == 1 and l[idx + 1] == 1:  # 黒を繋げてしまう場合
                        ans -= 1
                elif idx == 0 and 1 < N:
                    if l[idx + 1] == 0:  # 黒を作ってしまった場合
                        ans += 1
                elif idx == N - 1 and 1 < N:
                    if l[idx - 1] == 0:
                        ans += 1
            else:  # 黒 -> 白
                if idx != 0 and idx != N - 1:
                    if l[idx - 1] == 1 and l[idx + 1] == 1:  # 新たに白を作った場合
                        ans += 1
                    elif l[idx - 1] == 0 and l[idx + 1] == 0:
                        ans -= 1
                elif idx == 0 and 1 < N:
                    if l[idx + 1] == 0:  # 島を消してしまった場合
                        ans -= 1
                elif idx == N - 1 and 1 < N:
                    if l[idx - 1] == 0:
                        ans -= 1
