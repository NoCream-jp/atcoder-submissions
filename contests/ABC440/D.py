...
def main():
    ...
    Aをソートして，Aにたいする二分探索でスタート地点を決める．

    大きすぎるなら計算O(1)なので，大きくないと仮定して，手順書くと
    ・Aの中で一番近くてxより大きいものをさがす
    ・見つけた大きいものとxとの間のどこにxが入るかAに対する二分探索(left)で確認する i
    ・左と

    startとx+yの間に挟まる数をにぶたんする
    """
