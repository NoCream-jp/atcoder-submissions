...
def main():
    ...
    [5 4 4 3 1 1] < 逆から累積和
    でも桁が変わる
    桁が変わるのは自分で書き換えればいいしどこまで行ってもlog10までしか触らない？
    """
    ...
    ans = [str(cml[i]) for i in range(1, mx+1)]
    print("".join(ans))
...
# セグメント木
class SegmentTree:
    def __init__(self, n, func, ide_ele, arr=None):  # 要素数, 計算に使う関数, 単位元，木に入れる配列
        self.n = n
        self.func = func
